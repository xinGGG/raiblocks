...
void rai::wallet_store::serialize_json (MDB_txn * transaction_a, std::string & string_a)
{
	...
	for (rai::store_iterator<rai::uint256_union, rai::uint256_union> i (std::make_unique<rai::store_iterator_impl<rai::uint256_union, rai::uint256_union>>(transaction_a, handle)), n (nullptr); i != n; ++i)
	{
